      ...
      <div className={style.ac}>
        ...
        <div className={style.info}>
          ...
          <p>
            ...
            manera exitosa en el cual adquiri . En el mismo adquirí
            conocimientos en tecnologias de desarrollo web con Javascript,
            NodeJS, Express, PostgreSQL y Sequelize. Tambien aprendi a usar
            Typescript, MongoDB y Mongoose de manera autodidacta. Me gusta la
            programacion y siempre estoy buscando aprender mas...
          </p>
          <div>
